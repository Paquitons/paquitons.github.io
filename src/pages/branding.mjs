...
<div class="container bg-layout">
  ...
  <div class="bg-content">
    ...
    <section class="bg-section" id="type" aria-labelledby="type-title">
      ...
      <p class="bg-note">Navine, DIN Condensed and Futura are commercial fonts; League Gothic and Archivo are free (SIL Open Font License). Anything that isn’t the logo or print artwork should use Archivo.</p>
    </section>
